...
for semantic_type in semantic_type_lis:
    ...
    for scene_name in lis_name_scenes:
        ...
        semantic_predicted_lis = sorted(glob(f'{dir_scan}/semantic/{semantic_type}/*.png'))
        ...
        path_log = f'{dir_scan}/semantic/{semantic_type}_evalsemantic_{semantic_class}_{MANHATTAN}_{str_date}_markdown.md'
