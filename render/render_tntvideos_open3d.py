...
#### copy from monosdf, for new coordinate
...
exps_dir = f'/home/du/Proj/3Dv_Reconstruction/NeuRIS/exps/indoor/neus/{scan}/neuris_test4'
mesh_path = f'{exps_dir}/meshes/00160000_reso128_scene0050_00.ply'
out_path = f'{exps_dir}/rendering/meshes'
